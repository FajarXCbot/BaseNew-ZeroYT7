...
zero.sendMessage(`6288239440253@s.whatsapp.net`, options, text, { quoted: ftrol })
reply('Masalah Telah Di Laporkan Ke Owner BOT, Mohon Tunggu Untuk Proses Perbaikan')
break
case 'youtube':
teks =
`Nih Youtube Owner Ku Jangan Lupa Di Subscribe Ya https://youtube.com/FajarKyonari`
zero.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'instagram':
teks =
...
case 'tiktok':
teks =
`Nih Tiktok Owner Ku Jangan Lupa Di Follow Ya https://tiktok.com/@imyourexhaha`
zero.sendMessage(from, teks, text, {quoted: ftrol})
break
case "runtime":
case "test":
